...
public class Bicicletas implements ITransportes {
    private Integer cp;
    ...
    public Bicicletas(Integer cp, Float dimensionX, Float dimensionY, Float dimensionZ, Float peso) {
        this.cp = cp;
    ...
    public Float costeTotal(Integer cp) {
        while (cp > 37000 || cp < 36000) {
            cp = LibreriaPedirDatos.pedirint("A este codigo postal non chegamos, ten que ser maior que 36000 e menor que 37000");
        }
